...
In case you want to configure WordPress as multisite, you will have to activate it by accessing the activation wizard: Admin -> Configurations -> Network Setup. Follow the detailed instructions there. To access and modify the files indicated there, you have two options:
